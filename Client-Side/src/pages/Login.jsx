      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex flex-1 items-center justify-center px-6">
          ...
          <motion.div
            ...
            className="w-full max-w-md rounded-3xl border border-cyan-500/20 bg-[#1E293BCC] p-10 shadow-[0_0_60px_rgba(37,99,235,.2)] backdrop-blur-xl"
          >
            ...
            >
              ...
              <motion.button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 py-3 font-semibold text-white shadow-lg transition duration-300 hover:shadow-cyan-500/40"
              >
                Login
              </motion.button>
